...
// (título, descripción, orden) — usado para Servicios y Valores de Nosotros.
const ContentItemsPanel = ({ heading, apiPath, itemLabel = 'elemento' }) => {
            ...
            <tbody>
              {items.map(item => (
                <tr key={item.id} className="border-b border-gray-200 dark:border-white/10 text-[13px] text-gray-900 dark:text-white">
                  ...
                  <td className="px-4 py-3 text-gray-500 max-w-md truncate">{item.description}</td>
